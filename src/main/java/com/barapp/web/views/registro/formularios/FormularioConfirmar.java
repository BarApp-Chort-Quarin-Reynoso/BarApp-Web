...
import com.barapp.web.views.utils.events.SuccessfulRegistrationEvent;
...
//                () -> getClass().getResourceAsStream("/META-INF.resources/images/portada_barapp.png"));
    ...
    private void configurarLayout() {
        ...
        this.add(tituloFormularioH3,confirmaDatosParagraph, formLayout,
                imagenesParagraph, imagenesLayout, botonesLayout);
    }
